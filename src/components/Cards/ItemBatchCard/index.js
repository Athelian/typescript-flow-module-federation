...
const ItemBatchCard = ({
  ...
  return (
    <BaseCard icon="BATCH" color="BATCH" showActionsOnHover actions={actions} {...rest}>
      <div className={ItemBatchCardWrapperStyle} onClick={() => onClick(batch)} role="presentation">
        <div
...
ItemBatchCard.defaultProps = defaultProps;

export default withForbiddenCard(ItemBatchCard, 'batch', {
  width: '195px',
  height: '291px',
  entityIcon: 'BATCH',
  entityColor: 'BATCH',
