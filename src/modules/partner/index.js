...
import { PARTNER_CREATE, PARTNER_GET, PARTNER_LIST } from 'modules/permission/constants/partner';
...
const PartnerFormModuleDetailWrapper = withForbidden(PartnerFormModuleWrapper, PARTNER_GET);
