...
export const ORDER_ITEMS_DOWNLOAD_DOCUMENTS = 'order.orderItemsFiles.downloadDocuments';
...
export const ORDER_ITEMS_DOCUMENT_SET_STATUS = 'order.orderItemsFiles.setStatus';
