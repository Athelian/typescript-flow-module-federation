...
export default defineMessages({
  ...
  tags: {
    ...
    defaultMessage: 'Tags'.toUpperCase(),
  },
  totalPackages: {
    id: 'modules.container.totalPackages',
    defaultMessage: 'Total Packages'.toUpperCase(),
  },
  totalBatchQuantity: {
    id: 'modules.container.totalBatchQuantity',
    defaultMessage: 'Total Batched Quantity'.toUpperCase(),
  },
  totalUniqueItems: {
    id: 'modules.container.totalUniqueItems',
    defaultMessage: 'Total Unique Items'.toUpperCase(),
  },
  totalVolume: {
    id: 'modules.container.totalVolume',
    defaultMessage: 'Total Volume'.toUpperCase(),
  },
  totalWeight: {
    id: 'modules.container.totalWeight',
    defaultMessage: 'Total Weight'.toUpperCase(),
  },
  totalPrice: {
