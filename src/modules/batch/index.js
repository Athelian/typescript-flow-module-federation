...
import { BATCH_CREATE, BATCH_GET, BATCH_LIST } from 'modules/permission/constants/batch';
...
const BatchFormModuleDetailWrapper = withForbidden(BatchFormModuleWrapper, BATCH_GET);
