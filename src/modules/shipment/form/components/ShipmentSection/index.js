  ...
  return (
    <Subscribe to={[ShipmentInfoContainer]}>
      {({
        ...
        const transportationTypeSelect = (
                ...
                >
                  {({ name, ...inputHandlers }) => (
                    <EnumSelectInputFactory
                      ...
                      hideTooltip={values.autoTracking} // The tooltip tends to overflow
                      label={
                        <FormattedMessage
            ...
            <div className={ShipmentSectionWrapperStyle}>
              <div className={MainFieldsWrapperStyle}>
                <GridColumn>
                  ...
                  {!values.autoTracking && transportationTypeSelect}
                  <FormField
                    name="loadType"
                  ...
                  {!values.autoTracking && carrierTypeSelect}
                  <CustomFieldsFactory
                    entityType="Shipment"
